...
\begin{itemize}
    \item Consider the face with vertices $ (0,0,0), (1,0,0), (0,1,0) $. \\
    ...
    \item Consider the face with vertices $ (0,0,0), (1,0,0), (0,0,1) $. \\
    \subitem The unit normal vector at this point is strictly in the $ z $ direction. \\
    ...
    \item Consider the face with vertices $ (0,0,0), (0,1,0), (0,0,1) $. \\
    \subitem The unit normal vector at this point is strictly in the $ z $ direction. \\
    ...
    \subitem This face is a triangle with area $ \displaystyle \frac{1}{2}m^2 $ \\
    \subitem The flux through this face is $ \displaystyle \rho \iint \limits_{S} \textbf{F} \cdot \textbf{n} \, dA = 400\tfrac{kg}{s} \cdot -1\tfrac{m}{s} \cdot \frac{1}{2}m^2 = -200\tfrac{kg}{s} $ \\
    \item Consider the face with vertices $ (1,0,0), (0,1,0), (0,0,1) $. \\
...
\begin{itemize}
    ...
    \item We can now substitute into the original equation. \\
...
\noindent
\textbf{First} transform the PDE to an ODE by the Fourier sine transform. \\
...
\noindent
\textbf{First} we will use separation of variable to obtain 2 ODEs. \\
...
\begin{itemize}
    ...
    \item Substitute $ A_n $ and $ B_n $ into $ u(x,t) $. \\
...
\begin{itemize}
    ...
    \item Substitute $ \displaystyle v = y + 2x \ ; \ w = y + x $ into $\displaystyle U $ to obtain $ \displaystyle u $. \\
