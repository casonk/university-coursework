...
As this likelihood function is an exponential family of distributions, it is straightforward to see that the pair $ \ds \bigl( \sum_{k=1}^{n} X_{k} , X_{(1)} \bigr) $ is sufficient for $ (\theta_{1}, \theta_{2}) $. \\
