...
Individuals are being persuaded by bots, Trump is banned from twitter while president, and ideologies are becoming seemingly more radicalized.
...
If we find that the communities detected within a graph have a higher number of internal links than the expected number of internal links, we are able to lessen the issue with finding giant communities, especially in the trivial case.
...
Computational complexity is a good reference for scalability of an algorithm, and provides an upper limit on the size of usable networks.
...
\bibliography{konzer_cason_mth_402_paper_final.bib}{}
