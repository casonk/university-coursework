...
The final implementation was a customized software which was built by an implementer specialized in ERP for ship building and knowledgeable of the specialized engineering software in use. 
