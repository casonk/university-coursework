...
In general, requirements are based on design and scope of the application planned to run on the hardware.
...
Dependent upon frequency of use, customers can opt to manage there resources directly via means of IaaS, or have them managed by AWS through PaaS.
...
\bibliography{konzer_cason_inb_385_project.bib}{}
