...
\begin{itemize}
      ...
      \item \underline{Internal Vertex}: An internal vertex in analogous to an internal point given the path is an edge between two vertices,  $ v_i $ and $ v_f $, with a vertex $ v $ inbetween. 
