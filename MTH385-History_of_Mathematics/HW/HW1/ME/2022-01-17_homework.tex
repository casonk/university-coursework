...
\begin{proof}
  ...
  \begin{itemize}
    \item We can divide this equation by $c^2$ to arrive at the following.
...
\begin{proof} 
  ...
  \begin{itemize}
    ...
    \item Consider the case of subtraction.
    \subitem $\displaystyle x=\frac{-2t^{2}-2}{2(t^{2}+1))}=\frac{-2(t^{2}+1)}{2(t^{2}+1)}=-1$
    \subitem This solution is trivial and can be identified as point $Q$ from our earlier figure.
    \item Consider the case of addition.
