...
\noindent
Given our sample is sufficiently large our sampling distribution is approximately normally distributed, by the central limit theorem. \\

\noindent
From our sample we can construct an estimate for the probability of a voter panning to vote `yes,' our sample statistic \dots \\ 
