...
Within the processor there are additional bottlenecks form serving usable instructions. 
...
When \emph{redesigning the processor}, engineers have implemented a half cycle decode stage to make the condition known, and utilized the first half of the execute stage to perform condition checking. 
...
Once we begin to exploit \emph{issue parallelism}, our previous exploitations of \emph{temporal parallelism} become increasingly important. 
