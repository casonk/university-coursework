...
\begin{frame}
    ...
    \centering
    \includegraphics[scale = 0.33]{enterprise_sizes.jpg}
...
\begin{frame}
    ...
    \centering
    \includegraphics[scale = 0.33]{Onsite-Iaas-Paas-Saas.png}
...
\begin{frame}
    ...
    \centering
    \includegraphics[scale = 0.44]{summary_of_articles.PNG}
...
\begin{frame}
    ...
    \centering
    \includegraphics[scale = 0.33]{adoption_factors.jpg}
