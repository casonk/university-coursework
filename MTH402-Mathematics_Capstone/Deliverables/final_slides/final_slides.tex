...
\titlegraphic{\includegraphics[scale = 0.5]{University_of_Michigan_Flint.png}}
\date[]{\today} 
...
\begin{frame}
    ...
    \includegraphics[width=\textwidth]{Web_Page_Example.PNG}
...
\begin{frame}
    ...
    \includegraphics[width=\textwidth]{Social_Media_Example.PNG}
...
\begin{frame}
    ...
    \includegraphics[width=\textwidth]{Transit_Example.PNG}
...
\begin{frame}
    ...
    \includegraphics[width=\textwidth]{Community_Example.PNG}
...
\begin{frame}
    ...
    \vspace{2.5mm}
    \begin{itemize}
        \item Shortest Path Betweenness.\pause
        \item Random Walk Betweenness.\pause
