...
Here $ p $ is an unknown parameter and $ \displaystyle 0 \leq p \leq \frac{1}{3} $. \\
...
\noindent
We will first find the likelihood and log-likelihood function, then sent the partial derivatives to zero, last solve the system of equations to find the $ MLE $.
