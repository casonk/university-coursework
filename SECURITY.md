...
For `university-coursework`, security-sensitive reports should be handled privately by the repository owner.
...
- Do not commit private student records, unpublished grades, or third-party datasets that are not licensed for redistribution.
