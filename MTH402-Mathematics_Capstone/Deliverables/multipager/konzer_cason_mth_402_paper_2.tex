...
We have the prior directed adjacency matrix, and the following expectation matrix :
...
Computational complexity is a good reference for scalability of an algorithm, and the upper limit of size of usable networks.
...
\bibliography{konzer_cason_mth_402_paper_2.bib}{}
